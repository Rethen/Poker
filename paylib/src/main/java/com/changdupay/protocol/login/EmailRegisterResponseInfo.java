...
public class EmailRegisterResponseInfo extends BaseResponseInfo{
	public EmailRegisterResponseInfo()
	{
		super();
		
		this.mActionID = PayConst.EMAILCHECK_ACTION;
	}
	...
	public String getSignString()
	{
		...
		str.append(PayConst.EMAILREGISTER_ACTION);
