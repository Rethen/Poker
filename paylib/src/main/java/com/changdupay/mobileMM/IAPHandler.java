package com.changdupay.mobileMM;
...
public class IAPHandler extends Handler {
	...
	private iCDPayChooseMoneyMobileMMActivtiy context;

	public IAPHandler(Activity context) {
		this.context = (iCDPayChooseMoneyMobileMMActivtiy) context;
	}
...
//	}
	...
	public void showDialog(String title, String msg) {
		...
		builder.setIcon(context.getResources().getDrawable(R.drawable.pay_icon));
